...
class JournalController extends Controller
{
    ...
    protected $comment = [
        'offset' => 2,
        'author' => 'Boris Bobford',
        'message'=> 'This is such a great idea! Let me know how it turns out.'
    ];
    ...
    public function read() {
        ...
        return view('journal.read', ['journal' => $this->journal1, 'entry' => $this->entry, 'comments' => $this->comment]);
    }
